...
public class AuthenticationController {
    ...
    public ResponseEntity<?> register(@RequestBody User user) {
        ...
        if(user.getUsername() == null || user.getPassword() == null){
            return new ResponseEntity<>(new ErrorResponse("missing username or password !!"), HttpStatus.BAD_REQUEST);
        }
        ...
        if(!existUser.isEmpty()) {
               return new ResponseEntity<>(new ErrorResponse("username already exist !"), HttpStatus.CONFLICT);
        }
        ...
        try {
            ...
            if(existUser.isEnabled()) {
                if(jwtTokenUtil.validateToken(_token, existUser)) {
                    com.quest.etna.model.UserDetails us =  new com.quest.etna.model.UserDetails(existUser.getUsername(), UserRole.valueOf(details.get().getRole()));
